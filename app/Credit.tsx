    ...
    return (
        <ScrollView>
            <View style={styles.back}>
                ...
                <Text style={{marginLeft:15,fontSize:20,fontWeight:600}}>Achat de cedit </Text>
            </View>
            ...
            <View style={{margin:10}}>
                <TouchableOpacity style={styles.one}>
                    ...
                    <Text style={{marginLeft:10, fontSize:18,fontWeight:600}}>Acheter du credit pour un nouveau numero</Text>
                </TouchableOpacity>
